        ...
        <div>
            ...
            <div id="wd-css-hyperlink-list">
                ...
                <div className="list-group">
                    ...
                    Lord of the Rings</a>
                    <a href="https://en.wikipedia.org/wiki/The_Forever_War" target="_blank"
                    className="list-group-item list-group-item-action">
                    The Forever War</a>
                    <a href="https://en.wikipedia.org/wiki/2001:_A_Space_Odyssey_(novel)" target="_blank"
                    className="list-group-item list-group-item-action">
                    2001 A Space Odyssey</a>
                    <a href="https://en.wikipedia.org/wiki/Ender%27s_Game" target="_blank"
